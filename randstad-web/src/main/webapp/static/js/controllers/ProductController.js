define(['app'], function(app){
    ...
    app.register.controller('listProduct', ['$scope','$http', function($scope,$http,$location){
    	$scope.count = 0;   
	    //变量  
	    $scope.p_current = 1;  
	    $scope.p_all_page =0;  
	    ...
	    var _get = function(page,size,callback){ 
	    	console.log(1);
	        $http.get("product/getProductPage?page="+page+"&size="+size)
